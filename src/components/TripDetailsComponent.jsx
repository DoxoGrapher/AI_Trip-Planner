...
const TripDetailsComponent = () => {
  ...
  return (
    <div className="mx-auto px-[15%] py-12 rounded-lg shadow-lg w-full">
      ...
      <div className="text-lg text-gray-700 mb-10 flex flex-row gap-10">
        <p className='bg-gray-300 px-3 py-1 rounded-lg font-semibold'>{tripDetails.days.length} Days</p>
        <p className='bg-gray-300 px-3 py-1 rounded-lg font-semibold'>{tripDetails.to}</p>
        <p className='bg-gray-300 px-3 py-1 rounded-lg font-semibold tracking-wide'>{tripDetails.budget}</p>
      </div>

      <div className='border-2 border-black/10 rounded-lg p-10 space-y-10'>
